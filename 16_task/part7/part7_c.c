/*
*	Эта программа выступает в роли первого
*	клиента, который подключается к "слушающему"
*	серверу, получает от него порт "обслуживающего"
*	сервера и подключается к нему. Отправляет ему данные,
*	"Test text", далее получает преобразованные данные.
*/
