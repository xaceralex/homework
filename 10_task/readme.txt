1) part1.c Реализовать программу, которая порождает процесс. Родительский
...
2) part2.c Реализовать программу, которая порождает процесс1 и процесс2, ждет
	...
	pid, ppid. Ниже приведена схема с родительскими и дочерними процессами:
...
3) part3.c Реализовать аналог командного интерпретатора bash. При запуске
